...
class RestApiTests extends Specification {
    ...
    def cleanupSpec() {
        long totalTime = System.currentTimeMillis() - screenTest.serviceTime
    ...
    @Unroll
    def "call service REST API (#requestMethod, #screenPath, #containsTextList)"() {
        expect:
        ...
        // Test service Rest API here
        // "put" | "s1/service/exampleendpoint" | [moquiSessionToken:token] | ['55800']
    }
}
